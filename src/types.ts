...
export interface MeteogramCardConfig {
    ...
    show_legend?: boolean; // Show the top Temperature/Precipitation legend labels (default true)
    day_grid?: boolean; // Vertical gridlines only at midnight & midday instead of every hour
